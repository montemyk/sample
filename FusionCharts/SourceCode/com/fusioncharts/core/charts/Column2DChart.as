...
class com.fusioncharts.core.charts.Column2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function Column2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String)
	{
	...
	private function drawColumns ()
	{
		...
		for (i = 1; i <= this.num; i ++)
		{
			...
			if (this.data [i].isDefined)
			{
				...
				colIns = new Column2D (colMC, this.data [i].w, this.data [i].h, this.params.plotBorderColor, this.params.plotBorderAlpha, this.params.plotBorderThickness, this.data [i].color, this.data [i].alpha, this.data [i].ratio, this.params.plotFillAngle, false, this.data [i].dashed, this.params.plotBorderDashLen, this.params.plotBorderDashGap);
				//Draw the column
				colIns.draw ();
