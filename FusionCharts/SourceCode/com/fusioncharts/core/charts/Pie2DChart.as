...
class com.fusioncharts.core.charts.Pie2DChart extends Chart {
	...
	*/
	function Pie2DChart(targetMC:MovieClip, depth:Number, width:Number, height:Number, x:Number, y:Number, debugMode:Boolean, lang:String) {
		...
		this.log("Chart Type", "2D Pie Chart Chart", Logger.LEVEL.INFO);
	...
	*/
	private function parseAttributes(graphElement:XMLNode):Void {
		...
		this.params.showNames = toBoolean(getFN(atts["shownames"], 1));
	...
	*/
	 ...
	 * parseXml method. It creates  instances of Pie2D class,
	...
	private function pieOnRollOver():Void {
		...
		if (strLink == '' || strLink == undefined || !this.config.enableLinks || insRef.params.clickURL != '') {
